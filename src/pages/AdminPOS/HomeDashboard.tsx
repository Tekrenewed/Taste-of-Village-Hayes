...
import { User, Phone, Check, X, ChevronRight } from 'lucide-react';
...
export const HomeDashboard: React.FC<HomeDashboardProps> = ({ 
  ...
  const waitingOrders = (orders || []).filter(o => o?.status === 'web_holding');
  const actionedOrders = (orders || [])
    .filter(o => o?.status !== 'web_holding')
    .sort((a,b) => {
  ...
  return (
    <div className="space-y-12">
      <div>
        <h3 className="font-display text-2xl font-bold border-b border-cream/10 pb-2 mb-8">Waiting in Store</h3>
        ...
        <h3 className="font-display text-2xl font-bold border-b border-cream/10 pb-2 mt-12 mb-8">Actioned / Completed</h3>
