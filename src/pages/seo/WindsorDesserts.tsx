...
export const WindsorDesserts = () => {
  const schema = JSON.stringify({
    ...
    "description": "Looking for luxury halal desserts near Windsor? Falooda & Co is just a 10-minute drive down the A332, offering late-night desserts, cookie dough, and Indian street food."
  });
  ...
  return (
    <div className="bg-brand-cream min-h-screen pt-20 pb-20 font-sans">
      <SEOHead 
        ...
        description="Craving late-night halal desserts near Windsor? Take a short 10-minute drive to Falooda & Co for luxury cookie dough, milkshakes, and Indian street food."
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-brand-text/70 leading-relaxed max-w-2xl mx-auto">
            Windsor is beautiful, but when the late-night cravings hit, the options can be limited. Just a short drive away on the vibrant Farnham Road, Falooda & Co offers the ultimate luxury dessert experience.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-brand-text/70 leading-relaxed mb-6">
              Looking for something more exotic than standard ice cream? Our renowned Royal Heritage Falooda is the perfect blend of sweet basil seeds, Rooh Afza, and rich Kulfi, bridging the gap between traditional South Asian sweets and modern luxury.
            </p>
